...
export const mainLoadingTips = [
  ...
  'Try our new Awesomize feature to enhance your search queries!',
  'Click the magic wand icon to Awesomize your query and get more specific results.',
];
...
export const additionalLoadingTips = [
  ...
  'Awesomize uses AI to generate more targeted search options based on your initial query.',
  'Not sure how to phrase your search? Let Awesomize suggest some options!',
  'Stuck with broad results? Awesomize your query to narrow down your search.',
  'Awesomize is like having an AI assistant to help refine your tool search.',
  'Awesomize can help you find more specialized tools for your specific needs.',
];
