...
def parse_gitignore(gitignore_path):
    ...
    # add images to ignore
    ignore_patterns.append("*.png")
    ignore_patterns.append("*.ico")
    ignore_patterns.append("*.svg")
...
def should_ignore(path, root, ignore_patterns):
    ...
    if "pnpm-lock.yaml" in rel_path.split(os.sep):
        return True
    if "scripts" in rel_path.split(os.sep):
        return True
    if ".next" in rel_path.split(os.sep):
        return True
    if ".ico" in rel_path.split(os.sep):
        return True
    if ".png" in rel_path.split(os.sep):
        return True
    if ".svg" in rel_path.split(os.sep):
        return True
